    ...
    <article className="bg-white p-5 shadow-sm sm:p-8">
      <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        <div>
          ...
          <h2 className="mt-6 text-3xl font-semibold leading-tight text-ink">{section.title}</h2>
          <div className="mt-7 space-y-6 text-base leading-8 text-stone-700">
            <div>
              <h3 className="mb-2 text-lg font-semibold text-ink">项目背景</h3>
              <p>{section.background}</p>
            </div>
            <div>
              <h3 className="mb-2 text-lg font-semibold text-ink">服务内容</h3>
            ...
            <div>
              <h3 className="mb-2 text-lg font-semibold text-ink">核心结果</h3>
              <p>{section.result}</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-5">
          <ImageBlock src={section.image} alt={section.title} className="aspect-[16/10]" />
