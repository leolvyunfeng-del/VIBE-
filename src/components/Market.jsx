import { marketOpportunities } from "../data/content.js";
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
          <SectionHeader
            ...
            title="为什么选择俄罗斯市场"
            description="俄罗斯不是简单的流量市场，而是一个需要理解平台、语言、渠道与信任机制的本地化市场。越早建立清晰的市场打法，品牌越容易形成持续增长。"
          />
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            <div className="border border-white/12 bg-white/8 p-5">
        ...
        <div className="mt-14 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
          {marketOpportunities.map((item) => {
            ...
            return (
              <article
                key={item.title}
                className="border border-white/12 bg-white/[0.06] p-6 transition hover:border-ember/70 hover:bg-white/[0.09]"
              >
